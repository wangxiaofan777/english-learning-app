...
- ✅ **课时编排**：每话题「对话实战 → 听力精听 → 跟读评分」三课循环，12 个月班每单元附加复习课（对接 FSRS 生词复习）；完课自动推进解锁
...
- ✅ **成长体系**：全行为产出经验值（XP）——每日打卡 +5、对话 +30、精听 +20、跟读 +25、复习每词 +2、速测每题 +3；等级头衔从「英语新手」到「英语大师」；11 枚成就徽章成就墙
- ✅ **每日一句**：每天一句金句带发音，给用户每天打开的理由
- ✅ **词汇速测**：中译英 4 选 1 快问快答小游戏，答对涨经验
...
- ⏳ V1：音素级发音评测（腾讯智聆/讯飞）、非首选话题的真实 LLM 内容重写、订阅支付、App 流式
