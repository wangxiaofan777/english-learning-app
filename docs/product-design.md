...
| 轻量练习 | ✅ | 词汇速测（中译英 4 选 1 涨经验）、自由聊天（不限场景 AI 聊伴）、精听理解小测（听英文选中文） |
| 前端 | ✅ | 十二个页面（5 Tab：今天/课程/练口语/词库/我的）；H5 与微信小程序构建通过；App 端随 uni-app 输出（非流式降级） |
| 端到端验证 | ✅ | 16/16 API 冒烟（含 XP/成就/自由聊天）+ 浏览器全流程走查 |
